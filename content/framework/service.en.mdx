...
description: "Organize replaceable plugin capabilities with services and dependencies."
---
...
- [Event system](/en/framework/events) — communicate between plugins without tight coupling
- [Capability layering](/en/practice/) — use services as capability interfaces
