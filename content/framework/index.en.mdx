...
description: "Understand Cordis plugin loading, scopes, disposal, and reloads."
---
...
- [Services and dependencies](/en/framework/service) — expose a capability to other plugins
- [Event system](/en/framework/events) — communicate between plugins
