...
description: "Create a minimal Harness plugin and load it into the Web UI."
---
...
Function form is sufficient in most cases. Use class form when the plugin provides a service to other plugins; see [services and dependencies](/en/framework/service).

## Next steps

- [Build a tool](/en/basic/tool) — learn the tool definition DSL
- [Plugin configuration](/en/basic/config) — accept user configuration
