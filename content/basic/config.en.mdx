...
description: "Define, validate, and consume deployable plugin configuration."
---
...
Express self-contained constraints in the schema so invalid configuration fails while the plugin loads. References to services or registered resources require dependency injection; the [services tutorial](/en/framework/service) introduces that contract.
...
- [Package and install a plugin](/en/basic/publish) — ship the plugin as an installable package
- [Plugins and lifecycle](/en/framework/) — understand the full plugin lifecycle
- [Services and dependencies](/en/framework/service) — provide a service to other plugins
