---
title: "Build the Song-inspired UI theme"
description: "Build a Song-inspired Web UI theme as a reversible token layer."
---
...
Complete [your first plugin](/en/basic/) and [services and dependencies](/en/framework/service), then read the [Web UI style reference](https://github.com/deepseek-ai/DeepSeek-Harness/blob/master/docs/web-styling.md). Start from a repository checkout with dependencies installed.
