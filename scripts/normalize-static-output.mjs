...
const defaultLanguagePath = new URL('zh/', publicPath);
const rscPath = new URL('RSC/R/', publicPath);
const defaultLanguageRscPath = new URL('zh/', rscPath);
...
function normalizeDefaultLanguageContent(content) {
  return content
    .replaceAll(`${siteOrigin}/zh/`, `${siteOrigin}/`)
    .replaceAll('"markdownUrl":"/zh/', '"markdownUrl":"/')
    .replaceAll('\\"markdownUrl\\":\\"/zh/', '\\"markdownUrl\\":\\"/')
    .replaceAll('route:/zh/', 'route:/')
    .replaceAll('route:/zh"', 'route:/"')
    .replaceAll('route:/zh\\"', 'route:/\\"')
    .replaceAll('layout:/zh/', 'layout:/')
    .replaceAll('layout:/zh"', 'layout:/"')
    .replaceAll('layout:/zh\\"', 'layout:/\\"')
    .replaceAll('page:/zh/', 'page:/')
    .replaceAll('page:/zh"', 'page:/"')
    .replaceAll('page:/zh\\"', 'page:/\\"')
    .replaceAll('"ROUTE":["/zh/', '"ROUTE":["/')
    .replaceAll('"ROUTE":["/zh"', '"ROUTE":["/"')
...
await cp(new URL('zh.txt', rscPath), new URL('../R.txt', rscPath), {
  force: true,
});
