...
- [Cordis tutorial](https://github.com/deepseek-ai/DeepSeek-Harness/blob/master/docs/cordis-tutorial/index.md) — the plugin framework underneath, built from a scratch directory with no API key
