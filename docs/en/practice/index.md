...
The [capability-seam reference](https://github.com/deepseek-ai/DeepSeek-Harness/blob/master/docs/capability-seams.md) owns the current built-in families and package links.
