...
- [Cordis tutorial](https://github.com/deepseek-ai/DeepSeek-Harness/blob/master/docs/cordis-tutorial/index.md) — the same lifecycle, services, and events built step by step against the Cordis runtime
