...
The repository generates the service names, public methods, and source locations into each service's [subsystem page](https://github.com/deepseek-ai/DeepSeek-Harness/blob/master/docs/subsystems/core.md). Use those generated regions and the service's TypeScript interface while developing a plugin; do not maintain a second static list.
